...
<body>
    ...
    <section class="banner set-bg" data-setbg="{{ asset('themes/ashion//img/banner/banner-1.jpg') }}">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                    ...
                    <div class="trend__content">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('themes/ashion//img/trend/ht-1.jpg') }}" alt="">
                            </div>
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('themes/ashion//img/trend/ht-2.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('themes/ashion//img/trend/ht-3.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="trend__content">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('themes/ashion//img/trend/bs-1.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                                <h6>Cotton T-Shirt</h6>
                                <div class="rating">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('themes/ashion//img/trend/bs-2.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('themes/ashion//img/trend/bs-3.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="trend__content">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('themes/ashion//img/trend/f-1.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('themes/ashion//img/trend/f-2.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('themes/ashion//img/trend/f-3.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                ...
                <div class="col-lg-4 col-md-6 col-sm-7">
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="./index.html"><img src="{{ asset('themes/ashion//img/logo.png') }}"
                                    alt=""></a>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                            cilisis.</p>
                        <div class="footer__payment">
                            <a href="#"><img src="{{ asset('themes/ashion//img/payment/payment-1.png') }}"
                                    alt=""></a>
                            <a href="#"><img src="{{ asset('themes/ashion//img/payment/payment-2.png') }}"
                                    alt=""></a>
                            <a href="#"><img src="{{ asset('themes/ashion//img/payment/payment-3.png') }}"
                                    alt=""></a>
                            <a href="#"><img src="{{ asset('themes/ashion//img/payment/payment-4.png') }}"
                                    alt=""></a>
                            <a href="#"><img src="{{ asset('themes/ashion//img/payment/payment-5.png') }}"
                                    alt=""></a>
                        </div>
                    </div>
                </div>
